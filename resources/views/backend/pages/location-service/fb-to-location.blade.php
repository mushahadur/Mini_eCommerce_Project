...
@section('contain')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Facebook ID To location</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                        <li class="breadcrumb-item active">Facebook ID To location</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    ...
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">Facebook ID To location অর্ডার করুন।</h3>
                        </div>
                        <div class="card card-danger card-outline m-2">
                            <div class="card-header">
                                <h5 class="card-title text-danger">Facebook ID To location এর জন্য 1500.00 টাকা কাটা হবে।</h5>
                            </div>
                        </div>
                        ...
                        <form>
                            ...
                            <div class="form-group px-3">
                                <label>Facebook ID To Location সম্পর্কে বিস্তারিত লিখুনঃ(যদি কিছু বলার থাকে)</label>
