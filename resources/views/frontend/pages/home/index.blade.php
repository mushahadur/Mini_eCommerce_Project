...
@section('contain')
                        ...
                        <div class="hero-slider">
                            ...
                            <div class="single-slider"
                                ...
                                <div class="content">
                                    ...
                                    <div class="button">
                                        <a href="{{route('details')}}" class="btn">Shop Now</a>
                                    </div>
                                </div>
                            </div>
                            <!-- End Single Slider -->
                        ...
                        <div class="col-lg-12 col-md-6 col-12">
                            ...
                            <div class="hero-small-banner style2">
                                <div class="content">
                                    ...
                                    <div class="button">
                                        <a class="btn" href="{{route('details')}}">Shop Now</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Start Small Banner -->
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        ...
                        <div class="product-info">
                            ...
                            <h4 class="title">
                                <a href="{{route('details')}}">Big Power Sound Speaker</a>
                            </h4>
                            <ul class="review">
                                <li><i class="lni lni-star-filled"></i></li>
                                <li><i class="lni lni-star-filled"></i></li>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        ...
                        <div class="product-info">
                            ...
                            <h4 class="title">
                                <a href="{{route('details')}}">WiFi Security Camera</a>
                            </h4>
                            <ul class="review">
                                <li><i class="lni lni-star-filled"></i></li>
                                <li><i class="lni lni-star-filled"></i></li>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        ...
                        <div class="product-info">
                            ...
                            <h4 class="title">
                                <a href="{{route('details')}}">iphone 6x plus</a>
                            </h4>
                            <ul class="review">
                                <li><i class="lni lni-star-filled"></i></li>
                                <li><i class="lni lni-star-filled"></i></li>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        ...
                        <div class="product-info">
                            ...
                            <h4 class="title">
                                <a href="{{route('details')}}">Wireless Headphones</a>
                            </h4>
                            <ul class="review">
                                <li><i class="lni lni-star-filled"></i></li>
                                <li><i class="lni lni-star-filled"></i></li>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        ...
                        <div class="product-info">
                            <span class="category">Speaker</span>
                            <h4 class="title">
                                <a href="{{route('details')}}">Mini Bluetooth Speaker</a>
                            </h4>
                            <ul class="review">
                                <li><i class="lni lni-star-filled"></i></li>
                                <li><i class="lni lni-star-filled"></i></li>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        ...
                        <div class="product-info">
                            <span class="category">Headphones</span>
                            <h4 class="title">
                                <a href="{{route('details')}}">PX7 Wireless Headphones</a>
                            </h4>
                            <ul class="review">
                                <li><i class="lni lni-star-filled"></i></li>
                                <li><i class="lni lni-star-filled"></i></li>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        ...
                        <div class="product-info">
                            ...
                            <h4 class="title">
                                <a href="{{route('details')}}">Apple MacBook Air</a>
                            </h4>
                            <ul class="review">
                                <li><i class="lni lni-star-filled"></i></li>
                                <li><i class="lni lni-star-filled"></i></li>
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="single-banner" style="background-image:url('{{asset('/')}}assets/images/banner/banner-1-bg.jpg')">
                        <div class="content">
                            ...
                            <div class="button">
                                <a href="{{route('details')}}" class="btn">View Details</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- End Banner Area -->
       ...
       <section class="Most Popular-product section" style="margin-top: 5px;">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
